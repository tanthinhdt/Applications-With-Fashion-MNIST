...
class VGG19(nn.Module):
    def __init__(self, img_size, img_channel, n_classes):
        ...
        cnn_block1_kernel_sizes = [3, 3]
        cnn_block1_strides = [1, 1]
        cnn_block1_paddings = [1, 1]
        ...
        cnn_block2_kernel_sizes = [3, 3]
        cnn_block2_strides = [1, 1]
        cnn_block2_paddings = [1, 1]
        ...
        cnn_block3_channels = [cnn_block2_channels[-1], 256, 256, 256, 256]
        cnn_block3_kernel_sizes = [3, 3, 3, 3]
        cnn_block3_strides = [1, 1, 1, 1]
        cnn_block3_paddings = [1, 1, 1, 1]
        ...
        cnn_block4_channels = [cnn_block3_channels[-1], 512, 512, 512, 512]
        cnn_block4_kernel_sizes = [3, 3, 3, 3]
        cnn_block4_strides = [1, 1, 1, 1]
        cnn_block4_paddings = [1, 1, 1, 1]
        ...
        # 4 convolutional layers with
        # 512 filters, kernel size 3x3, stride 1, padding 1, ReLU
        cnn_block5_channels = [cnn_block4_channels[-1], 512, 512, 512, 512]
        cnn_block5_kernel_sizes = [3, 3, 3, 3]
        cnn_block5_strides = [1, 1, 1, 1]
        cnn_block5_paddings = [1, 1, 1, 1]
