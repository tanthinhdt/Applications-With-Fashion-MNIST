...
class ResNet34(nn.Module):
    def __init__(self, img_size, img_channel, n_classes) -> None:
        ...
        # max pooling layer with kernel size 3x3, stride 2
        ...
        # residual block 3 with 2 convolutional layer, each has:
        # kernel size 3x3, 64 filters, stride 1, padding 1
        res_block3_channels = [res_block2_channels[-1], 64, 64]
        res_block3_kernel_sizes = [3]
        res_block3_strides = [1]
        ...
        # residual block 5 with 2 convolutional layer, each has:
        # kernel size 3x3, 128 filters, stride 1, padding 1
        res_block5_channels = [res_block4_channels[-1], 128, 128]
        res_block5_kernel_sizes = [3]
        res_block5_strides = [1]
        ...
        # kernel size 3x3, 128 filters, stride 1, padding 1
        res_block6_channels = [res_block5_channels[-1], 128, 128]
        ...
        # residual block 7 with 2 convolutional layer, each has:
        # kernel size 3x3, 128 filters, stride 1, padding 1
        res_block7_channels = [res_block6_channels[-1], 128, 128]
        res_block7_kernel_sizes = [3]
        res_block7_strides = [1]
        ...
        # residual block 9 with 2 convolutional layer, each has:
        # kernel size 3x3, 256 filters, stride 1, padding 1
        res_block9_channels = [res_block8_channels[-1], 256, 256]
        res_block9_kernel_sizes = [3]
        res_block9_strides = [1]
        res_block9_paddings = [1]
        self.features.extend(ResidualBlock(channels=res_block9_channels,
                                           kernel_sizes=res_block9_kernel_sizes,
                                           strides=res_block9_strides,
                                           paddings=res_block9_paddings).get_block())

        # residual block 10 with 2 convolutional layer, each has:
        # kernel size 3x3, 256 filters, stride 1, padding 1
        res_block10_channels = [res_block9_channels[-1], 256, 256]
        res_block10_kernel_sizes = [3]
        res_block10_strides = [1]
        res_block10_paddings = [1]
        self.features.extend(ResidualBlock(channels=res_block10_channels,
                                           kernel_sizes=res_block10_kernel_sizes,
                                           strides=res_block10_strides,
                                           paddings=res_block10_paddings).get_block())

        # residual block 11 with 2 convolutional layer, each has:
        # kernel size 3x3, 256 filters, stride 1, padding 1
        res_block11_channels = [res_block10_channels[-1], 256, 256]
        res_block11_kernel_sizes = [3]
        res_block11_strides = [1]
        res_block11_paddings = [1]
        self.features.extend(ResidualBlock(channels=res_block11_channels,
                                           kernel_sizes=res_block11_kernel_sizes,
                                           strides=res_block11_strides,
                                           paddings=res_block11_paddings).get_block())

        # residual block 12 with 2 convolutional layer, each has:
        # kernel size 3x3, 256 filters, stride 1, padding 1
        res_block12_channels = [res_block11_channels[-1], 256, 256]
        res_block12_kernel_sizes = [3]
        res_block12_strides = [1]
        res_block12_paddings = [1]
        self.features.extend(ResidualBlock(channels=res_block12_channels,
                                           kernel_sizes=res_block12_kernel_sizes,
                                           strides=res_block12_strides,
                                           paddings=res_block12_paddings).get_block())

        # residual block 13 with 2 convolutional layer, each has:
        # kernel size 3x3, 256 filters, stride 1, padding 1
        res_block13_channels = [res_block12_channels[-1], 256, 256]
        res_block13_kernel_sizes = [3]
        res_block13_strides = [1]
        res_block13_paddings = [1]
        self.features.extend(ResidualBlock(channels=res_block13_channels,
                                           kernel_sizes=res_block13_kernel_sizes,
                                           strides=res_block13_strides,
                                           paddings=res_block13_paddings).get_block())

        # residual block 14 contains:
        ...
        res_block14_channels = [res_block13_channels[-1], 512, 512]
        res_block14_kernel_sizes = [3]
        res_block14_strides = [2, 1]
        res_block14_paddings = [1]
        self.features.extend(ResidualBlock(channels=res_block14_channels,
                                           kernel_sizes=res_block14_kernel_sizes,
                                           strides=res_block14_strides,
                                           paddings=res_block14_paddings).get_block())
        img_size = (img_size - 3) // 2 + 1

        # residual block 15 with 2 convolutional layer, each has:
        # kernel size 3x3, 512 filters, stride 1, padding 1
        res_block15_channels = [res_block14_channels[-1], 512, 512]
        res_block15_kernel_sizes = [3]
        res_block15_strides = [1]
        res_block15_paddings = [1]
        self.features.extend(ResidualBlock(channels=res_block15_channels,
                                           kernel_sizes=res_block15_kernel_sizes,
                                           strides=res_block15_strides,
                                           paddings=res_block15_paddings).get_block())

        # residual block 16 with 2 convolutional layer, each has:
        # kernel size 3x3, 512 filters, stride 1, padding 1
        res_block15_channels = [res_block14_channels[-1], 512, 512]
        res_block15_kernel_sizes = [3]
        res_block15_strides = [1]
